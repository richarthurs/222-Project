...
wi_hammer = sqrt((4*g*d)/(.5*r^2+d^2)); % Angular velocity of the hammer right before impact with the ball
w_int_hammer = sqrt((2*g*h)/(0.5*r^2+d^2)); % Intermediate angular velocity, right after impact with the ball
