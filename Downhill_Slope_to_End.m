function [ Master_Array, forceData ] = Downhill_Slope_to_End( Master_Array, forceData, Incline_Angle, Length )
%Test
...
dist_travelled = abs(Start_AngVel)*R*t_inc + 0.5*abs(Ang_Acc)*R*t_inc^2;
