...
x = 0.02;
[F_spring, data] = initSpring(data, x); % Will update the data matrix with the initial velocity and angular velocity after it is launched from the spring
% Data matrix is also updated with the normal force
